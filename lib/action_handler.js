...
function start() {
    ...
    currentPrompt = new Prompt('prompt', "You can search for a product, search for a receipe, o rorder a product from a product barcode. Say \'Search\', \'Receipe\', or just send a picture of a barcode.", ['search, receipe']);
}
