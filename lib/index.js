...
fuction loadElements(products){
	var elements;

	for (let i = 0; i < products.length; i++){
		var element = {
			"title": results.products[i].productName,
			"subtitle": results.products[i].description,
			"image_url": results.products[i].primaryImage,
		}
