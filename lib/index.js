	...
	for (let i = 0; i < messaging_events.length; i++) {
		...
		if (event.message && event.message.text) {
			...
			/*else if (text.includes("recipe: ")){
				unirest.get("https://community-food2fork.p.mashape.com/search?key=9a266ac158d1966f7a00f043259f2c5e&q=beef")
       .header("X-Mashape-Key", "RNsZ2tiy2pmshxmPkPRrn6viHrUwp1UZ22BjsnbuPVLyEnTS57")
